...
public class ProductService {
    ...
    public void addFolder(Long productId, Long folderId, User user) {
        ...
        if (!product.getUser().getUserId().equals(user.getUserId())
                || !folder.getUser().getRole().equals(user.getRole())) {
    ...
    public Page<ProductResponse> getProductsInFolder(Long folderId, int page, int size, String sortBy, boolean isAsc,
                                                     User user) {
        ...
        Page<Product> products = productRepository.findAllByUserAndProductFolderList_Folder_FolderId(user, folderId,
                pageable);

        Page<ProductResponse> responseDtoList = products.map(ProductResponse::new);
